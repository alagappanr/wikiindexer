...
/**
 * @author nikhillo This interface simply defines constants that are used to
 *         load the properties. DO NOT EDIT THIS FILE. We will be replacing this
 *         with our version of the file when we run tests.
 */
